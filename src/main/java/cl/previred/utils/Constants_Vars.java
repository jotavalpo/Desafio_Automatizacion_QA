...
public class Constants_Vars {
    ...
    public static final String URL_TEST = "https://opencart.abstracta.us/index.php?route=common/home";

    /*** Constantes para configuracion de properties ***/
